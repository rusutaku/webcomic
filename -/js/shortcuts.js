...
jQuery( function( $ ) {
	...
	$.hotkeys.add( 'right', function() { webcomic_shortcut( '.previous-webcomic-link' ); } );
	$.hotkeys.add( 'left', function() { webcomic_shortcut( '.next-webcomic-link' ); } );
	$.hotkeys.add( 'shift+right', function() { webcomic_shortcut( '.first-webcomic-link' ); } );
	$.hotkeys.add( 'shift+left', function() { webcomic_shortcut( '.last-webcomic-link' ); } );
